...
class Quest:
    ...
    Attributs:
        ...
        description (str): La description de la quête.
        objectives (list): Liste des objectifs à accomplir.
        is_completed (bool): Indique si la quête est terminée.
        is_active (bool): Indique si la quête est actuellement active.
        reward (str): Récompense optionnelle pour avoir terminé la quête.
    """
    ...
    def complete_quest(self, player=None):
        """
        Marque la quête comme terminée et donne la récompense au joueur.
